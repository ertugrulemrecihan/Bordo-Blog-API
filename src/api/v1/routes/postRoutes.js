...
router.route('/getAll/my').get(authenticate, controller.fetchAllMyPosts);    // ! FIXME: Abone olmalı
router.route('/get/my/:id').get(authenticate, controller.fetchOneMyPost);    // ! FIXME: Abone olmalı
...
router.route('/create').put(authenticate, bodyValidator(schemas.createValidation), controller.create);
router.route('/delete/my/:id').delete(authenticate, paramIdValidator, controller.deleteMyPost);
router.route('/update/my/:id').patch(authenticate, paramIdValidator, bodyValidator(schemas.updateValidation), controller.updateMyPost);
...
router.route('/addTag/:id').post(authenticate, paramIdValidator, bodyValidator(schemas.addTag), controller.addTag);
router.route('/removeTag/:id').post(authenticate, paramIdValidator, bodyValidator(schemas.removeTag), controller.removeTag);
